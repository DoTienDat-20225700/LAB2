...
<<<<<<<< HEAD:src/.metadata/.plugins/org.eclipse.core.resources/.history/88/d0aeb3c14bab001f19b6bf49aec23e1a
   //Setter for title
public void setTitle(String title) {
    if (title != null && !title.trim().isEmpty()) {
        this.title = title;
...
>>>>>>>> refactor/packages:hust/soict/aims/disc/DigitalVideoDisc.java
